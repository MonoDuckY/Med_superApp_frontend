...
import { FlaskConical, LogOut, Shield, User, Phone, CheckCircle2, Check } from "lucide-react";
                  ...
                  <div className="flex flex-col gap-0.5">
                    ...
                    {userRoles.includes("RESEARCHER") && (
                      <button
                        ...
                        className="w-full text-left text-[11px] px-2 py-1 rounded transition-colors flex items-center justify-between text-[#8B5CF6] font-bold bg-[#8B5CF6]/10 cursor-pointer border-none outline-none"
                      >
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-[500px] bg-white border border-[#E2E8F0] rounded-2xl p-10 shadow-sm flex flex-col items-center text-center">
          ...
          <div className="flex items-center gap-1.5 text-[11px] font-medium text-[#10B981]">
            ...
            <span>Dữ liệu lâm sàng được mã hóa ẩn danh</span>
          </div>
        </div>
      </main>
    </div>
