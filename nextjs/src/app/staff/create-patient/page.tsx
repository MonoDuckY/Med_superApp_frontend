...
export default function CreatePatientPage() {
  ...
  const sidebarItems = [
    { label: "Quản lý Lịch hẹn", icon: Calendar, path: "/staff", id: "appointments" },
    { label: "Phê duyệt Lịch Bác sĩ", icon: ClipboardList, path: "/staff", id: "schedules" },
        ...
        <div className="space-y-6">
          ...
          <nav className="px-3 space-y-1">
            {sidebarItems.map((item) => {
              const active = item.id === "create-patient";
          ...
          <div className="border-t border-slate-800 pt-4 flex items-center justify-between">
            <div className="flex items-center gap-3 min-w-0">
              <div className="w-8 h-8 rounded-full bg-[#0EA5E9]/15 border border-[#0EA5E9]/20 flex items-center justify-center font-bold text-[#38BDF8] text-xs shrink-0">
                {user.fullName.split(" ").pop()?.substring(0, 2).toUpperCase() || "ST"}
              </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-16 shrink-0 bg-white border-b border-[#E2E8F0] px-8 flex items-center justify-between">
          <div className="flex items-center gap-1.5 text-xs font-semibold">
            ...
            <span className="text-[#0F172A]">Tạo hồ sơ bệnh nhân</span>
          </div>
