...
export default function DatasetPanel({ user }: DatasetPanelProps) {
  ...
  return (
    <div className="flex-1 flex overflow-hidden w-full h-full">
      {/* ── Left Sidebar (32% width): Search & Patient List ── */}
      <div className="w-[32%] border-r border-[#E2E8F0] bg-white flex flex-col min-h-0 shrink-0">
        {/* Search header */}
        <div className="p-4 border-b border-[#F1F5F9] flex flex-col gap-3">
                ...
                {selectedRecord.medicalImages.map((img, i) => (
                  ...
                  >
                    ...
                    <div 
                      ...
                      className="relative cursor-zoom-in group/item flex items-center justify-center bg-black"
      ...
      {showLightbox && selectedRecord && activeImageIndex !== null && (
        <div 
        ...
        >
          ...
          <img 
            src={selectedRecord.medicalImages[activeImageIndex].url} 
            alt="Medical Scan Full Size" 
            className="max-w-[90vw] max-h-[85vh] object-contain rounded-lg shadow-2xl transition-transform duration-300 ease-out cursor-default"
            onClick={(e) => e.stopPropagation()}
          />
          ...
          >
            <span className="font-mono text-slate-300">
              {selectedRecord.medicalImages[activeImageIndex].imageId.toUpperCase()}
            </span>
            <span className="text-white/20">|</span>
            <a 
              href={selectedRecord.medicalImages[activeImageIndex].url} 
              target="_blank" 
              rel="noreferrer" 
